...
struct TemplateProject {
    ...
    private var readme: String {
        ...
        `Package.swift` declares only the app library. `sweb prepare`, `sweb dev`, and `sweb build` generate `.swiftweb/generated/server`, `.swiftweb/generated/dev`, and `.swiftweb/generated/wasm` for launchers, server execution, and WASM runtime builds.
        """
    }
