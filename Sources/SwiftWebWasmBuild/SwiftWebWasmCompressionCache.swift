...
package struct SwiftWebWasmCompressionCache: Sendable, Codable, Equatable {
    ...
    package mutating func remove(extensionName: String) {
        sidecars.removeValue(forKey: extensionName)
    }

    package func write(for artifactURL: URL) throws {
    ...
    package static func cacheURL(for artifactURL: URL) -> URL {
