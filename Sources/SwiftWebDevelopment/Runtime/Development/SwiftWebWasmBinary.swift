...
struct SwiftWebWasmBinary: Sendable, Equatable {
    struct Section: Sendable, Equatable {
        ...
        static func standardName(for id: UInt8) -> String {
            switch id {
            case 0: "custom"
            case 1: "type"
            case 2: "import"
    ...
    static let magic: [UInt8] = [0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00]
    static let defaultRemovedCustomSectionNames: Set<String> = [
        "name",
        "producers",
        "sourceMappingURL",
    ]
