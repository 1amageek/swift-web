...
struct SwiftWebDiagnosticsTests {
    ...
    func wasmRuntimeHostScriptUsesWasmExportsAndManifestLoading() {
        ...
        #expect(source.contains("data-swift-event-"))
        ...
        #expect(source.contains("swift-web-wasm-runtime-metrics"))
        #expect(source.contains("data-swift-web-wasm-phase"))
        ...
        #expect(source.contains("form[data-swift-server-action=\\\"true\\\"]"))
        #expect(source.contains("data-swift-server-action-button"))
        ...
        #expect(source.contains("addSwiftNodeSubtree(rawValue(component.nodeID), protectedNodeIDs, this, hydrationIndex)"))
        ...
        #expect(source.contains("this.publishStatus(runtimeWasReady, \"bundleLoaded\");\n      this.publishMetrics();"))
        #expect(source.contains("this.publishStatus(this.metrics.ready === true, \"bundleLoaded\");\n    this.publishMetrics();"))
    ...
    func javaScriptKitRuntimeCandidatesIncludeXcodeSourcePackagesPath() {
        ...
        #expect(candidates.map(\.path).contains(
