...
swift_executable="${SWIFT_WEB_HOST_SWIFT:-/Users/1amageek/Library/Developer/Toolchains/swift-6.4.x-DEVELOPMENT-SNAPSHOT-2026-08-14-a.xctoolchain/usr/bin/swift}"
toolchain_identifier="${SWIFT_WEB_XCODE_TOOLCHAIN:-org.swift.64202608141a}"
